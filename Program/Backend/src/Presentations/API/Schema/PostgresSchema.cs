...
internal sealed class PostgresSchema(IConfiguration configuration)
{
    ...
    public int Port => int.Parse(dbSettings["Port"] ?? throw new InvalidOperationException("Postgres:Port is missing"), System.Globalization.NumberStyles.Any, provider: System.Globalization.CultureInfo.InvariantCulture);
